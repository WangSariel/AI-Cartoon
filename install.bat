@echo off
chcp 65001 >nul
title AI-Cartoon Installer
cd /d "%~dp0"

echo ==========================================
echo    AI-Cartoon - One-Click Installer
echo ==========================================
echo.
...
echo.
echo Next steps:
echo   1. The backend now uses local SQLite by default: backend\manga.db
echo      No PostgreSQL or Docker is required for local testing.
echo   2. Double-click start.bat to launch AI-Cartoon.
